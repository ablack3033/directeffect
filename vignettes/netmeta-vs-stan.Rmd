...
correlated within a study, are the one place the engines differ:
...
every per-drug difference between the engines' estimates to stay below
0.02 on the log scale — and every difference between their standard
errors below 0.01 — on surface and anchored fits alike, on every
commit, in CI. The two implementations validate each other's
uncertainty as well as their point estimates.
